...
Контент для папки `client/public`:

- [public-content.zip (Яндекс Диск)](https://disk.yandex.ru/d/XV7SGZzvMzQ66A)

Этот контент нужен, чтобы в игре появились модели и звуки.
